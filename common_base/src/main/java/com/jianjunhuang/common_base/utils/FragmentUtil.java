...
public final class FragmentUtil {
   ...
   *     The id of container.
   * @param enterAnim
   *     An animation or animator resource ID used for the enter animation on the
   *     view of the fragment being added or attached.
   * @param exitAnim
   *     An animation or animator resource ID used for the exit animation on the
   ...
   *     The destination of fragment.
   * @param destTag
   *     The destination of fragment's tag.
   */
  public static void replace(@NonNull final Fragment srcFragment,
                             @NonNull final Fragment destFragment,
  ...
  public static void removeTo(@NonNull final Fragment removeTo, final boolean isIncludeSelf) {
    operateNoAnim(removeTo.getFragmentManager(),
                  TYPE_REMOVE_TO_FRAGMENT,
                  isIncludeSelf ? removeTo : null,
                  removeTo);
  }
  ...
  private static void operate(final int type,
    ...
    if (src != null && src.isRemoving()) {
      Log.e("FragmentUtil", src.getClass().getName() + " is isRemoving");
      return;
    }
    String name;
    Bundle args;
   ...
   *     The manager of fragment.
   * @param tag
   *     The tag of fragment will be found.
   *
   * @return the fragment matches class
   */
  public static Fragment findFragment(@NonNull final FragmentManager fm,
  ...
  private static class Args {
    ...
    private Args(final int id, final String tag, final boolean isHide, final boolean isAddStack) {
      this.id = id;
      this.tag = tag;
      this.isHide = isHide;
